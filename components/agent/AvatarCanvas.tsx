...
export default function AvatarCanvas({
  ...
  // Обновление вынесено в эффект без списка зависимостей: он выполняется после
  // каждого рендера, то есть ровно с той же частотой, что и присваивание в теле
  // компонента, но не читает ref во время самого рендера — это запрещено в
  // React 19 и ломало сборку.
  useEffect(() => {
