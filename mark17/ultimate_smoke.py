...
def main() -> int:
    ...
    _assert(ultimate.get("version") == "max_ultra_v1.77", "version should be max_ultra_v1.77")
    ...
    _assert(int(ultimate.get("doctrine_cached") or 0) >= 10, "v1.77 doctrine should be cached")
    ...
    _assert(isinstance(state, dict) and state.get("version") == "max_ultra_v1.77", "read-only ultimate state missing")
